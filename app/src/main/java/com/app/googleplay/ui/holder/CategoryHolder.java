...
public class CategoryHolder extends BaseHolder<CategoryInfo> implements View.OnClickListener{
    ...
    public View initView() {
        View view= UIUtils.inflate(R.layout.category_list_item);
    ...
    public void refreshData(CategoryInfo data) {
        ...
        mBitmapUtils.display(ivIcon1, HttpHelper.URL + data.url1);
        mBitmapUtils.display(ivIcon2, HttpHelper.URL + data.url2);
        mBitmapUtils.display(ivIcon3, HttpHelper.URL + data.url3);
    }
